...
function EmbedIntoTable(response,startNum,body){
    if(!response.status){
        ...
        $.each(response.data,function(key,value){
            ...
            tds.push($.CreateTd({'edit-enable':'true','edit-type':'input','name':'code','origin':value.code},{}, value.code));

            tds.push($.CreateTd({'edit-enable':'false','edit-type':'input','name':'user_count','origin':value.user_count},{}, value.user_count));
