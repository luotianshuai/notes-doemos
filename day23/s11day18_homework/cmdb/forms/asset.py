...
class Search(forms.Form):
    def __init__(self, *arg, **kwargs):
        super(Search, self).__init__(*arg, **kwargs)
        self.fields['search_type'].widget.choices = models.HostStatus.objects.all().values_list('id', 'hoststatus')
    search_type = forms.IntegerField(widget=forms.widgets.Select())
